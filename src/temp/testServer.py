...
from backgroundWorker import BackgroundClientWorker
...
class ClientWorker(Thread):
    ...
    def __init__(self, client_id: int, client_socket: socket, database: AppDatabase, server: Server):
        super().__init__()
        self.__id = client_id
...
if __name__ == "__main__":
    ...
    """ Parameters: IP Address, Port #, Backlog # """
